...
def test_version_comparison_prefers_newer_release():
    pyupdate = load_pyupdate_module()
...
def test_release_asset_selection_uses_platform_hints_and_checksums():
    pyupdate = load_pyupdate_module()
